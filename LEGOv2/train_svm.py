...
if __name__ == "__main__":
    ...
    for n in [25,50,75,100]:
        ...
        feature_type_dict_reduced = feature_dict(X_train_reduced)
        X_train_dict_reduced, X_train_auto_reduced, X_train_autoemo_reduced = split_features(X_train_reduced, feature_type_dict_reduced)
